...
!
      DO I=1,MAXLU_T2D
        ...
        ELSEIF(T2D_FILES(I)%TELNAME.EQ.'T2DSEC') THEN
          T2DSEC = I
        ELSEIF(T2D_FILES(I)%TELNAME.EQ.'BRILOC') THEN
          BRILOC = I
        ELSEIF(T2D_FILES(I)%TELNAME.EQ.'BRISEC') THEN
          BRISEC = I
...
!     gegese
!     NUMBER OF BRIDGES
      NBRIDGES = MOTINT( ADRESS(1, 125) )
      UMEANM = MOTINT( ADRESS(1, 128) )
      ALLOCATE(NODUMEAN(NBRIDGES))
      ALLOCATE(NODUMEANLOC(NBRIDGES))
      DO K=1,NBRIDGES
         NODUMEAN(K) = MOTINT( ADRESS(1,129) + K-1 )
      ENDDO
...
!     BRIDGE FILES, gegese
      T2D_FILES(BRILOC)%NAME=MOTCAR( ADRESS(4,126) )
      T2D_FILES(BRISEC)%NAME=MOTCAR( ADRESS(4,127) )
