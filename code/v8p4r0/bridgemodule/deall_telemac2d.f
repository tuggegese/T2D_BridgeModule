...
!
      ...
      !
!
!     deallocate bridge arrays, gegese   
!
      IF (NBRIDGES.GT.0) THEN
          IF(ALLOCATED(BRIDGE_BLOCK_LOC)) 
     &             DEALLOCATE(BRIDGE_BLOCK_LOC)
          IF(ALLOCATED(BRIDGE_BLOCK_SEC)) 
     &             DEALLOCATE(BRIDGE_BLOCK_SEC)
          IF(ALLOCATED(BRIDGE_GEO_CS)) 
     &             DEALLOCATE(BRIDGE_GEO_CS)
          IF(ALLOCATED(BRIDGE_BLOCK_LOC_RES)) 
     &             DEALLOCATE(BRIDGE_BLOCK_LOC_RES)
          IF(ALLOCATED(DISTTRI))
     &             DEALLOCATE(DISTTRI)
          IF(ALLOCATED(NODELOCAL)) 
     &             DEALLOCATE(NODELOCAL)
          IF(ALLOCATED(NODESTRING)) 
     &             DEALLOCATE(NODESTRING)
          IF(ALLOCATED(BNEIGHGLOB)) 
     &             DEALLOCATE(BNEIGHGLOB)
          IF(ALLOCATED(BNEIGHLOC)) 
     &             DEALLOCATE(BNEIGHLOC)
          IF(ALLOCATED(HABRIDGE)) 
     &             DEALLOCATE(HABRIDGE)
          IF(ALLOCATED(HAGEO)) 
     &             DEALLOCATE(HAGEO)
          IF(ALLOCATED(HABRIDGETEMP)) 
     &             DEALLOCATE(HABRIDGETEMP)
          IF(ALLOCATED(HAGEOTEMP)) 
     &             DEALLOCATE(HAGEOTEMP)
          IF(ALLOCATED(NPAIRLOC)) 
     &             DEALLOCATE(NPAIRLOC)
          IF(ALLOCATED(NPAIRGLOB)) 
     &             DEALLOCATE(NPAIRGLOB)
          IF(ALLOCATED(BRIDGE_BLOCK_SEC_RES)) 
     &             DEALLOCATE(BRIDGE_BLOCK_SEC_RES)
          IF(ALLOCATED(BRIDGE_BLOCK_GEO_RES)) 
     &             DEALLOCATE(BRIDGE_BLOCK_GEO_RES)
      ENDIF
!
!     Weirs (lecsng)
!
